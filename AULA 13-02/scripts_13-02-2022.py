"""
Claudinei de Oliveira - UTF8 - pt-br - 13-02-2023
...
# 5 - Atributos de instancia - privado - classe Lampada
class Lampada:
...
# 6 - Atributos de instancia - público - classe Lampada
class Lampada:
    def __init__(self, voltagem, cor, status):
...
# 24 - verificando a estrutura dos objetos produto_1 e produto_2
print('\n',dir(produto_1))
print('\n',dir(produto_2))
